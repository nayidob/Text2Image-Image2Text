...
def main():
    filename_text_image = {}
    set_environment(filename_text_image)


def set_environment(filename_text_image):
...
def encrypt(filename_text_image):
    print(filename_text_image)
    canvas_text = make_canvas(CANVAS_WIDTH // 5, CANVAS_HEIGHT // 5, 'Text File')
    ...
    length = count_char(text_filename, main_string, canvas_text)
